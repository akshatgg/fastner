      ...
      <td className="px-4 py-3 text-right">
        {locked ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-ink-200 px-3 py-1.5 text-xs font-semibold text-ink-700 transition hover:border-red-300 hover:text-red-600 disabled:opacity-50"
          >
